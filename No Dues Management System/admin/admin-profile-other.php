...
<html lang="en">
  ...
  <body>
	...
	<div style="margin-top:5%">
		<h2 align="center">Add Other Due</h2>
		<form class="form-horizontal" action="admin-add-other-due.php" method="post">
			...
			<?php
				if(isset($_GET['roll'])){
					...
					if(strcmp($r,"")==0&&strcmp($m,"")==0){
						$query1=mysql_query("select * from other_due order by roll_number",$connection); 
					}
					else if(strcmp($r,"")!=0&&strcmp($m,"")!=0){
						$query1=mysql_query("select * from other_due where roll_number='$r' and added_by='$m' order by added_on",$connection);	
					}
					else if(strcmp($m,"")!=0){
						$query1=mysql_query("select * from other_due where added_by='$m' order by roll_number",$connection);
					}
					else{
						$query1 = mysql_query("select * from other_due where roll_number='$r' order by added_on",$connection);
					}
				}
				else{
					$query1=mysql_query("select * from other_due order by roll_number",$connection);	
